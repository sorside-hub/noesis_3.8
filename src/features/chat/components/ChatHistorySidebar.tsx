      ...
      >
        ...
        <div className="h-14 px-4 border-b border-border-default flex items-center justify-between shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-text-primary text-bg-surface hover:opacity-90 transition-all cursor-pointer text-xs font-semibold shadow-xs"
          >
