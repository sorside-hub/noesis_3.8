  ...
  return (
    ...
    >
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2.5">
                  <TabIcon size={15} className={isSelected ? 'text-text-primary' : 'text-text-muted'} />
                  <span>{tab.label}</span>
                </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-2.5 bg-bg-surface/95 dark:bg-bg-surface/90 backdrop-blur-md border border-border-default rounded-full shadow-lg shadow-black/5 hover:border-border-hover transition-all cursor-pointer text-xs"
      >
        <div className="flex items-center gap-2.5 font-semibold text-text-heading">
          <CurrentTabIcon size={15} className="text-text-primary" />
