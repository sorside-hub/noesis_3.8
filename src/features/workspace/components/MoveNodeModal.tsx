      ...
      >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-7 py-1.5 bg-bg-primary border border-border-default rounded-lg text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-1 focus:ring-border-hover focus:border-border-hover"
          />
          {folderSearchQuery && (
            <button
              type="button"
