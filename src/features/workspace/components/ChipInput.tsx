  ...
  return (
    <div className="space-y-1.5">
      ...
      <div
        ...
        className="min-h-[42px] p-2 bg-bg-primary border border-border-default rounded-xl flex flex-wrap gap-1.5 items-center cursor-text transition-colors focus-within:border-border-hover focus-within:ring-1 focus-within:ring-text-muted/40"
      >
        {items.map((item) => (
          <span
            key={item}
