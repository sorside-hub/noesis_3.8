...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
  ...
  return (
    <div className="h-full w-full flex flex-col bg-bg-surface border-r border-border-default overflow-hidden select-none relative">
        ...
        <div ref={searchContainerRef} className="px-2.5 pt-2 pb-1.5 border-b border-border-subtle bg-bg-surface/90 shadow-xs z-10">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-7 pr-6 py-1.5 bg-bg-primary border border-border-default rounded-lg text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-1 focus:ring-border-hover focus:border-border-hover"
            />
            <button
              type="button"
      ...
      {/* Tree List (with smooth scrolling) */}
